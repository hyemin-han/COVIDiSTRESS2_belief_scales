...
compliance <- c('conspirational_think_1','conspirational_think_2',
...
#load data
load('../1_conspiracy/1_conspiracy.RData')
data<-dat
...
#general CFA
cfa.model.cle <- 'CLE =~ conspirational_think_1 + conspirational_think_2+ 
 conspirational_think_3 + conspirational_think_4'
...
simulation_CLE <- function(times,n,data,n.include,seed=1){
  ...
  for (j in 1:times){
    ...
    cfa.model.simul <- 'CLE =~ conspirational_think_1 + conspirational_think_2+ 
 conspirational_think_3 + conspirational_think_4'
